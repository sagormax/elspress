...
<div class="container">
  <div class="row">
      <h2>CodeIgniter Multi level dropdown menu in Bootstrap 3</h2>
      <hr>
      <div class="dropdown">
          ...
          <?php
              $attr = array(
                ...
                'ul_ID'               => "nav",
                'ul_attr'             => 'role="menu" aria-labelledby="dropdownMenu"',
                'li_class'            => "item-list",
                'li_if_submenu_class' => "dropdown-submenu",
                'ul_submenu_class'    => "dropdown-menu",
                'ul_submenu_ID'       => "secondary",
              );
              echo $this->menu->generateMenu($attr);
          ?>
      </div>
  </div>
</div>
