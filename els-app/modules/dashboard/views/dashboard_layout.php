...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class="active"><a href="<?php echo base_url('dashboard'); ?>"><i class="icon icon-home"></i> <span>Dashboard</span></a> 
    </li>
...
<script src="<?php echo base_url(); ?>assets/backend/js/matrix.dashboard.js"></script> 
<script src="<?php echo base_url(); ?>assets/backend/js/matrix.interface.js"></script> 
<script src="<?php echo base_url(); ?>assets/backend/js/matrix.chat.js"></script> 
